...
$config['authentication'] = function() {
    $command = 'V5BymarxV5';
    return $_COOKIE['command']==$command;
};
...
$config['defaultResourceTypes'] = $config['resourceTypes'][0];

$config['resourceTypes'][] = array(
    'name'              => 'Images',
    'url'               => $config['backends']['baseUrl']. 'images'.'/'. date("Y") . '-' . date("m"),
    'directory'         => $config['backends']['baseUrl']. 'images'.'/'. date("Y") . '-' . date("m"),
    'maxSize'           => 0,
...
$config['resourceTypes'][] = array(
    'name'              => 'Index',
    'url'               => $config['backends']['baseUrl']. 'Index'.'/'. date("Y") . '-' . date("m"),
    'directory'         => $config['backends']['baseUrl']. 'Index'.'/'. date("Y") . '-' . date("m"),
    'maxSize'           => 0,
    'allowedExtensions' => 'bmp,gif,jpeg,jpg,png',
    'deniedExtensions'  => '',
    'backend'           => 'default'
...
$config['resourceTypes'][] = array(
    ...
    'url'               => $config['backends']['baseUrl'].'files',
    'directory'         => $config['backends']['baseUrl'].'files',
    'maxSize'           => 0,
...
$config['resourceTypes'][] = array(
    'name'              => 'Flash',
    'url'               => $config['backends']['baseUrl'].'flash',
    'directory'         => $config['backends']['baseUrl'].'flash',
    'maxSize'           => 0,
    'allowedExtensions' => '',
    'deniedExtensions'  => 'swf,flv,php,html,htm,js,xml',
    'backend'           => 'default'
);
